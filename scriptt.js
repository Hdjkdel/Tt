const coins = [
    { name: "BTC", color: "btc", logo: "https://cryptologos.cc/logos/bitcoin-btc-logo.png", chance: 0.00000000000000000000, found: false },
    { name: "ETH", color: "eth", logo: "https://cryptologos.cc/logos/ethereum-eth-logo.png", chance: 0.00000000000000000000, found: false },
    { name: "TRX", color: "trx", logo: "https://cryptologos.cc/logos/tron-trx-logo.png", chance: 0.0000000000000000000000, found: false },
    { name: "USDT", color: "usdt", logo: "https://cryptologos.cc/logos/tether-usdt-logo.png", chance: 0.00000000000000000000000, found: false },
    { name: "SOL", color: "sol", logo: "https://cryptologos.cc/logos/solana-sol-logo.png", chance: 0.0000000000000000000000, found: false },
    { name: "DOGE", color: "doge", logo: "https://cryptologos.cc/logos/dogecoin-doge-logo.png", chance: 0.0000000000000000000, found: false },
    { name: "MATIC", color: "matic", logo: "https://cryptologos.cc/logos/polygon-matic-logo.png", chance: 0.0000000000000000000000, found: false }
];
...
function addFoundWallet(coin, value) {
    foundCount++;
    totalValue += value;
    ...
    totalValueEl.textContent = totalValue.toFixed(3) + "$";
}
...
function startScanning() {
    intervalId = setInterval(() => {
        ...
        // Eğer ekranın yüksekliği aşıldıysa, en üstteki adresi kaldır
        ...
        coins.forEach(coin => {
            if (!coin.found && Math.random() < coin.chance) { // Eğer olasılık sağlanırsa ve coin henüz bulunmadıysa
                const value = parseFloat((Math.random() * 1000).toFixed(1));
                addFoundWallet(coin.name, value);
